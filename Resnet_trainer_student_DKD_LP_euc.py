...
################把之前的MMD损失替换为欧氏距离##################      
        ...
        loss_cf_LP = 10*euclidean_loss(hs_LP, ht_LP)
...
def main():
    ...
    mkdir_if_missing('checkpoints')
    max_acc_ckpt = '/data4/tongshuo/Grading/CommonFeatureLearning/results/student/LP/%s_%s_%s_max_acc_ce_DKD_50_50_18_notran_LP_euc_10.pth'%(opts.model, opts.dataset, opts.layer)
    min_mae_ckpt = '/data4/tongshuo/Grading/CommonFeatureLearning/results/student/LP/%s_%s_%s_min_mae_ce_DKD_50_50_18_notran_LP_euc_10.pth'%(opts.model, opts.dataset, opts.layer)
    #  Set up dataloader
...
##### Loss #####
    ...
    while cur_epoch < opts.epochs:
        ...
        score_path = '/data4/tongshuo/Grading/CommonFeatureLearning/results/student/LP/%s_%s_%s_score_student_ce_DKD_50_50_18_notran_LP_euc_10.txt'%(opts.model, opts.dataset, opts.layer)
        score_best_path = '/data4/tongshuo/Grading/CommonFeatureLearning/results/student/LP/%s_%s_%s_score_student_best_ce_DKD_50_50_18_notran_LP_euc_10.txt'%(opts.model, opts.dataset, opts.layer)
