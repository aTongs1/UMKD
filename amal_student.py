...
def main():
    ...
    mkdir_if_missing('checkpoints')
    latest_ckpt = '/data3/tongshuo/Grading/CommonFeatureLearning/checkpoints/SD_DRamal_%s_latest.pth'%opts.model
    best_ckpt = '/data3/tongshuo/Grading/CommonFeatureLearning/checkpoints/SD_DRamal_%s_best.pth'%opts.model
    ...
    train_data = DRDataset(None,None,'valid',tran,0)
    val_data = DRDataset(None,None,'valid',tran,1)
    ...
    while cur_epoch < opts.epochs:
        ...
        if val_score['Overall Acc'] > best_score:  # save best model
            ...
            save_ckpt(best_ckpt)
            with open('/data3/tongshuo/Grading/CommonFeatureLearning/checkpoints/score_student_small_dataset.txt', mode='w') as f:
