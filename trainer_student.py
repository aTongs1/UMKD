...
def get_parser():
    ...
    parser.add_argument("--t1_ckpt", type=str, default='/data4/tongshuo/Grading/CommonFeatureLearning/results/teacher1/dr012_resnet34_max_acc_bce.pth')
    parser.add_argument("--t2_ckpt", type=str, default='/data4/tongshuo/Grading/CommonFeatureLearning/results/teacher2/dr34_resnet34_max_acc_bce.pth')
...
def main():
    ...
    mkdir_if_missing('checkpoints')
    max_acc_ckpt = '/data4/tongshuo/Grading/CommonFeatureLearning/results/student/%s_%s_max_acc_ce.pth'%(opts.dataset, opts.model)
    min_mae_ckpt = '/data4/tongshuo/Grading/CommonFeatureLearning/results/student/%s_%s_min_mae_ce.pth'%(opts.dataset, opts.model)
    #  Set up dataloader
    ...
    while cur_epoch < opts.epochs:
        ...
        with open('/data4/tongshuo/Grading/CommonFeatureLearning/results/student/score_student_ce.txt', mode='a') as f:
        ...
        if val_score['Overall Acc'] > max_acc:  # save best model
            ...
            with open('/data4/tongshuo/Grading/CommonFeatureLearning/results/student/score_student_best_ce.txt', mode='a') as f:
                f.write("Confusion Matrix:\n")
                f.write(str(val_score['Confusion Matrix']) + "\n")   
                f.write(metrics.to_str(val_score))
