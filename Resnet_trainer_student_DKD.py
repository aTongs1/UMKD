...
def main():
    ...
    mkdir_if_missing('checkpoints')
    max_acc_ckpt = '/data4/tongshuo/Grading/CommonFeatureLearning/results/student/%s_%s_max_acc_ce_DKD_50_50_18_notran_nopt.pth'%(opts.model, opts.dataset)
    min_mae_ckpt = '/data4/tongshuo/Grading/CommonFeatureLearning/results/student/%s_%s_min_mae_ce_DKD_50_50_18_notran_nopt.pth'%(opts.model, opts.dataset)
    #  Set up dataloader
    ...
    while cur_epoch < opts.epochs:
        ...
        score_path = '/data4/tongshuo/Grading/CommonFeatureLearning/results/student/%s_%s_score_student_ce_DKD_50_50_18_notran_nopt.txt'%(opts.model, opts.dataset)
        score_best_path = '/data4/tongshuo/Grading/CommonFeatureLearning/results/student/%s_%s_score_student_best_ce_DKD_50_50_18_notran_nopt.txt'%(opts.model, opts.dataset)
