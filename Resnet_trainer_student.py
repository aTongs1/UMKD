...
from loss import dkd_no_labels_loss
...
def get_parser():
    ...
    parser.add_argument("--t1_ckpt", type=str, default='/data4/tongshuo/Grading/CommonFeatureLearning/results/teacher1/resnet50_dr012_max_acc_ce.pth')
    # parser.add_argument("--t2_ckpt", type=str, default='/data4/tongshuo/Grading/CommonFeatureLearning/results/teacher2/resnet18_dr34_max_acc_ce.pth')
    parser.add_argument("--t2_ckpt", type=str, default='/data4/tongshuo/Grading/CommonFeatureLearning/results/teacher2/resnet50_dr34_max_acc_ce.pth')
...
def main():
    ...
    mkdir_if_missing('checkpoints')
    max_acc_ckpt = '/data4/tongshuo/Grading/CommonFeatureLearning/results/student/%s_%s_max_acc_ce_50_50.pth'%(opts.model, opts.dataset)
    min_mae_ckpt = '/data4/tongshuo/Grading/CommonFeatureLearning/results/student/%s_%s_min_mae_ce_50_50.pth'%(opts.model, opts.dataset)
    #  Set up dataloader
    ...
    while cur_epoch < opts.epochs:
        ...
        score_path = '/data4/tongshuo/Grading/CommonFeatureLearning/results/student/%s_score_student_ce_50_50.txt'%(opts.model)
        score_best_path = '/data4/tongshuo/Grading/CommonFeatureLearning/results/student/%s_score_student_best_ce_50_50.txt'%(opts.model)
